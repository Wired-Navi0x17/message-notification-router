...
| :--- | :--- | :--- | :--- | :--- |
| **Phase 0** | Foundation & Pipeline Infrastructure | 12 (v0.1 – v0.12) | 4 / 12 | 🔄 In Progress |
...
| **Stage 3** | `v0.3-history-retrieval` | ✅ Completed | `HistoryRetriever`, inverted indices & evidence matcher | Pending Commit | 2026-08-01 |
