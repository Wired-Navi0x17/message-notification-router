...
| :--- | :--- | :--- | :--- | :--- |
| **Phase 0** | Foundation & Pipeline Infrastructure | 12 (v0.1 – v0.12) | 8 / 12 | 🔄 In Progress |
...
| **Stage 7** | `v0.7-security-overrides` | ✅ Completed | `ScamDetector` & `SpamDetector` safety overrides | Pending Commit | 2026-08-01 |
